...
namespace ams::ssl::sf::impl {
    class SslContextImpl {
        protected:
            ...
            u64 m_context_id;
        public:
            SslContextImpl(std::unique_ptr<::Service> &&s, const sm::MitmProcessInfo &c, bool should_dump_traffic, PcapLinkType link_type, u64 context_id) : m_forward_service(std::move(s)), m_client_info(c), m_should_dump_traffic(should_dump_traffic), m_link_type(link_type), m_context_id(context_id) { /* ... */ }
